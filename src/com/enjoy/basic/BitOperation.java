...
public class BitOperation {
	...
	/*
	 * 问题：计算一个整数的二进制中有多少个1
	 * 分析：为了避免上述方法出现死循环，我们可以不右移输入的数字n，首先把n和1做与运算，判断n的最低位是不是为1
	 * .接着把1左移移位得到2，再和n做与运算，
	...
	/*
	 * 问题：计算一个整数的二进制中有多少个1 分析：针对此题，numberOf1_2解法中循环的次数等于二进制数的位数，32为的整数需要循环32次。
	 * 还有一种解法，再分析算法之前， 我们先来分析把一个数减去1的情况。如果一个整数不等于0，那么该整数的二进制中至少有一位是1.
	 * 先假设这个整数的最右边一位是1
